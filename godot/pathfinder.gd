...
func _ready():
	obstacles.append(create_obstacles_list([1, 13, 10, 100, 104, 108, 111, 117, 112, 12, 120, 126, 16, 2, 3, 4, 50, 55, 6, 8, 80, 89, 9, 90, 96]))
...
func return_path(world_start, world_end):
...
func create_obstacles_list(spritenums):
	for i in spritenums:
